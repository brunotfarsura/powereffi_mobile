...
class EnergyConsumptionData2 extends StatefulWidget {
  const EnergyConsumptionData2({super.key});

    final Text title = const Text("Cadastro de Perfil Energético");

  @override
  State<EnergyConsumptionData2> createState() => _EnergyConsumptionData2State();
}

class _EnergyConsumptionData2State extends State<EnergyConsumptionData2> {
